...
- __Navigation Bar__
  ...
  - On top of the page is a responsive navigation bar that collapses to house expandable links on mobile but houses interactive navigation buttons on desktop, it includes links to all the sections of the page and is fixed so its always accessible for the user to navigate around the page with ease
...
- __The hero image__
  ...
  - At the top of the site there is a Hero image of a sunset and skyline this helps promote the calm and relaxing environment that the site aims to create and captures the viewers, attention and this is where the inspiration for the colour theme of the site came from. It has an overlay of text that prompts the users to evaluate their mental health (inspired by the #asktwice campaign) and a call to action button that takes them straight to the cards section of the page where most of the information is presented 
...
- __About Us Section__
  ...
  - The About Us section introduces the user to the purpose and goals of the Mental Hue website
...
- __Feelings and symptoms section__
...
- __The learn more section__ 
  ...
  - contains an accordion with information about charities and websites that offer mental health support, referring them to check out these websites for more information
...
- In the future, I would like to implement a signup form or modal that allows the user to join an online community for all Mental Hue users, this form or modal would be linked to at the bottom of the page above the footer where the other social media links are
...
- I got relevant information about mental health issues from the NHS website as it is a reliable source [NHS](https://www.nhs.uk/)
- Instructions on how to fully utilise Bootstrap from this video series on YouTube [Specific YouTube Tutorials](https://www.youtube.com/playlist?list=PL4cUxeGkcC9joIM91nLzd_qaH_AimmdAR)
- The icons in the footer were taken from [Font Awesome](https://fontawesome.com/)

### Media

- The photos used on the card section are from Pexels
